...
particular, serán de nuestro interés los archivos {\bf \texttt{/var/log/messages} y 
\texttt{/var/log/kern.log} }, 
\vspace*{0.4cm} } }
...
\fcolorbox{black}{grey}{
\parbox[t]{1.0\linewidth}{ \vspace*{0.4cm}
{\bf Lo importante :} Incorporar el {\bf hábito} de consultar los archivos de bitácora e
identificar la información de interés para el recurso en cuestión, o bien la ausencia de la misma.
\vspace*{0.4cm} } }
